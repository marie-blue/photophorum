...
RSpec.describe "Topics", type: :request do
    ...
    context "guest" do
      describe "GET index" do
        ...
        describe "GET show" do
            it "returns http success" do
                get "/topics/", params: { id: my_topic.id }
                expect(response).to have_http_status(:success)
            end
        ...
        describe "POST create" do
            it "returns http redirect" do
              post "/topics/create", params: { topic: { name: RandomData.random_sentence, description: RandomData.random_paragraph } } 
              expect(response).to redirect_to(new_session_path)          
            end  
        end
        ...
        describe "PUT update" do
            it "returns http redirect" do
              ...
              put "/topics/update", params: { id: my_topic.id, topic: { name: new_name, description: new_description } }
              expect(response).to redirect_to(new_session_path)
            end
        end
        ...
        describe "DELETE destroy" do
            it "returns http redirect" do
                delete "/topics/destroy", params: { id: my_topic.id }
    ...
    context "member user" do
        before do
            user = User.create!(name: "Photo", email: "photo@email.com", password: "photophorum")
            create_session(user)
        end
        ...
        describe "GET show" do
          it "returns http success" do
            get "/topics/id", params: { id: my_topic.id }
            expect(response).to have_http_status(:success)
          end
        ...
        describe "GET edit" do
          it "returns http redirect" do
            get "/topics/id/edit", params: {id: my_topic.id}
            expect(response).to redirect_to(topics_path)
          end
        end
        ...
        describe "DELETE destroy" do
          it "deletes the topic" do
            delete "/topics", params: { id: my_topic.id }
            expect(response).to redirect_to(topics_path)
          end
        end
    end
